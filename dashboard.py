...
import subprocess
from state import total_profit, position_open, last_signal, cross_history, dashboard_data
...
<style>
  body {font-family: 'Courier New', monospace; margin: 2rem; background:#000000; color:#ffffff; line-height: 1.6;}
  .card {background:#111111; padding:1.2rem; margin:1.5rem 0; border-radius:10px; border:1px solid #333333;}
  h1 {color:#ffffff; text-align:center; font-size:2.2rem; font-weight:bold;}
  p {margin:0.6rem 0; font-size:1.1rem; color:#ffffff;}
  strong {color:#ffffff;}
  span[style*="green"], span[style*="red"] {font-weight:bold;}
  span[style*="#00FFFF"], span[style*="#FFFF00"] {font-weight:bold;}
  button {background:#666666; color:#000000; border:1px solid #888888; padding:0.7rem 1.5rem; font-size:1rem; font-weight:bold; border-radius:6px; cursor:pointer; transition:0.3s;}
  button:hover {background:#888888; border-color:#aaaaaa;}
  ul {padding-left:1.5rem;}
  li {margin:0.4rem 0; color:#cccccc;}
</style>
</head><body>
...
def index():
    ...
    pos = "OPEN" if position_open else "CLOSED"
